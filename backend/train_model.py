...
# X_train = np.random.rand(200, 17)  # 200 samples, 17 features
# y_train = np.random.randint(0, 17, 200)  # Predicting role (integer from 0 to 16)

# # Create a pipeline with feature scaling
# model = Pipeline([
#     ("scaler", StandardScaler()),
#     ("classifier", SVC(kernel="linear"))  # Use linear kernel for classification
# ])

# # Train the model
# model.fit(X_train, y_train)

# # Save the model and role mapping
